    ...
    def animate(self, delta_time):
        if self.reel_is_spinning:
            ...
            if self.delay_time <= 0:
                ...
                #Iterate through all 5 symbols in reel: truncate; add new symbol random on top of stack;  
...
class Symbol(pygame.sprite.Sprite):
    ...
    def update(self):
        # slighlty increase size of winning symbols
        if self.fade_in:
            if self.size_x < 320:
                self.size_x += 1
                self.size_y += 1
        ...
        # fade out of non winning symbols
